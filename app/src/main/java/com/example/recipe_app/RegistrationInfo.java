...
public class RegistrationInfo extends AppCompatActivity implements View.OnClickListener{
    ...
    public void saveUser() {
        ...
        String one = "1";
        cuisines.put("african", one);
        cuisines.put("chinese", one);
        cuisines.put("korean", one);
        cuisines.put("japanese", one);
        cuisines.put("vietnamese", one);
        cuisines.put("thai", one);
        cuisines.put("irish", one);
        cuisines.put("italian", one);
        cuisines.put("spanish", one);
        cuisines.put("british", one);
        cuisines.put("indian", one);
        cuisines.put("mexican", one);
        cuisines.put("french", one);
        cuisines.put("eastern", one);
        cuisines.put("middle", one);
        cuisines.put("american", one);
        cuisines.put("jewish", one);
        cuisines.put("southern", one);
        cuisines.put("caribbean", one);
        cuisines.put("cajun", one);
        cuisines.put("greek", one);
        cuisines.put("nordic", one);
        cuisines.put("german", one);
        cuisines.put("european", one);
        cuisines.put("eastern", one);
